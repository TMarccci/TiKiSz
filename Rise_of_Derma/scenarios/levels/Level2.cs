...
namespace Rise_of_Derma.scenarios
{
    public class Level2
    {
        public (int, Player, bool) InitLevel2(int elapsed, Player player, bool gameOver)
        {
            if (gameOver == false) 
            {
                // Print debug
                ...
                Matrix matrix = new Matrix(File.ReadAllLines("./scenarios/builds/Level2.txt", encoding: System.Text.Encoding.UTF8), true, elapsed, player, 2);
